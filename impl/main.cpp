...
int main(int argc, char** argv) {
  ...
  ImageManager img("test_img/morrow_small.bmp");
  ImageManager img_guess("test_img/morrow_small_guess.bmp");

  // img_guess.SaveTo("test_img/morrow_small_guess_copy.bmp");

  // ImageManager(img.GetLaplacian()).SaveTo("test_img/morrow_small_laplacian.bmp");

  FGBGMatte matte(&img, &img_guess);

  ImageManager matte_img(matte.GetMatte());

  matte_img.SaveTo("test_img/morrow_small_result.bmp");
